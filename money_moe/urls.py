...
urlpatterns = [
    ...
    path(
        "login/<str:url1>/<str:url2>/<str:url3>/<str:url4>/",
        users_views.auth_view,
        name="login-view-pay",
    ),
    path(
        "login/",
        users_views.LoginClassView.as_view(redirect_authenticated_user=True),
        name="login-view",
    ),
    ...
    path(
        "referral-code/", users_views.referral_verify_view, name="referral-verify-view"
    ),
    path(
        "logout/",
