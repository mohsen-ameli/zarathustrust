...
urlpatterns = [
    ...
    path(
        "<int:pk>/invite-friends", account_views.ReferralCodeView, name="referral-code"
    ),
    ...
    path(
        "payment/<str:url1>/<str:url2>/<str:url3>/<str:url4>/",
        account_views.payment,
        name="payment",
    ),
    path(
        "payment/<str:url1>/<str:url2>/<str:url3>/<str:url4>/<str:price>/payment_done/",
        account_views.payment_done,
        name="payment-done",
    ),
]
